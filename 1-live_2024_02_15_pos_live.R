...
### Live de Estudo de Caso - 15/02/2024
...
tjsp_baixar_cjsg(livre = exp,
                 classe = "307",
                 assunto = "",
                 orgao_julgador = "0-435,0-436,0-433,0-81,0-103,0-110,0-947,0-802,0-80,0-440,0-1246,0-94,0-117,0-123,0-967,0-1006,0-1164,0-96,0-108,0-118,0-694,0-968,0-1165,0-1264,0-97,0-119,0-703,0-1166,0-99,0-109,0-120,0-704,0-445,0-446,0-100,0-121,0-695,0-447,0-688,0-450,0-451,0-971,0-452,0-453,0-454,0-800,0-455,0-801,0-456,0-457,0-459,0-460,0-1188,0-82,0-705,0-692,0-948,0-803,0-83,0-462,0-463,0-465,0-466,0-1189,0-84,0-104,0-706,0-699,0-949,0-86,0-468,0-470,0-471,0-1192,0-85,0-111,0-122,0-961,0-89,0-472,0-474,0-475,0-1228,0-87,0-632,0-112,0-700,0-962,0-92,0-476,0-478,0-479,0-1008,0-1229,0-88,0-113,0-696,0-963,0-994,0-95,0-480,0-482,0-483,0-1243,0-90,0-105,0-114,0-701,0-964,0-926,0-98,0-484,0-485,0-1244,0-91,0-106,0-115,0-693,0-965,0-972,0-486,0-1245,0-93,0-107,0-116,0-702,0-966,0-1140,0-642,0-643,0-646,0-647,0-644,0-645,0-904,0-224,0-641,0-640,0-0,0-1313,0-1308,0-911,0-913,0-633,0-636,0-637,0-634,0-945,0-639,0-638,0-1005,0-635,0-1076,0-912",
                 inicio = "01/01/2023",
                 fim = "31/12/2023",
                 inicio_pb = "",
                 fim_pb = "",
...
tabela |>
  group_by(assunto)  |>  # agrupar por comarcas
  count(sort = TRUE)  |>  # contar ocorrências
  head()  # ver os primeiros resultados

tabela |>
  group_by(relator)  |>  # agrupar por comarcas
  count(sort = TRUE)  |>  # contar ocorrências
  head()  # ver os primeiros resultados

tabela |>
  group_by(orgao_julgador)  |>  # agrupar por comarcas
  count(sort = TRUE)  |>  # contar ocorrências
  head()  # ver os primeiros resultados
...
## Quero saber a maneira como é julgado
dispositivo |>
